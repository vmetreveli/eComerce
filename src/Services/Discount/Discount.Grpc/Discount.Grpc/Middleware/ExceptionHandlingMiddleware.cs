...
using ApplicationException = Discount.Grpc.Domain.Exceptions.ApplicationException;
...
internal sealed class ExceptionHandlingMiddleware : IMiddleware
{
    ...
    private static int GetStatusCode(Exception exception) =>
        exception switch
        {
            BadRequestException => (int)StatusCode.Unavailable,//StatusCodes.Status400BadRequest,
            NotFoundException => (int)StatusCode.NotFound,
